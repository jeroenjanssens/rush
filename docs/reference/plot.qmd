...
renders the plot using
[devoutansi](https://github.com/coolbutuseless/devoutansi). Use `-O ascii`
for plain-text output or `-O ansi` for colored output with ANSI escape codes:
