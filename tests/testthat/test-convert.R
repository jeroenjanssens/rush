...
test_that("rush_convert json to csv", {
  script <- capture_script(rush_convert, file = "data.json", output = "out.csv")
...
test_that("rush_convert csv to ods", {
  script <- capture_script(rush_convert, file = "data.csv", output = "out.ods")
